...
tf.keras.utils.get_custom_objects().update({'TFOpLambda': Lambda(tf_op_lambda)})
...
model = tf.keras.models.load_model('best_plant_model (3).h5', custom_objects={'TFOpLambda': Lambda(tf_op_lambda)})
